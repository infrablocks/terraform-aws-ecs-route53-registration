  ...
  namespace :secrets do
    namespace :gpg do
      RakeGPG.define_generate_key_task(
        ...
        owner_comment: 'terraform-aws-ecs-route53-registration CI Key'
      )
    end
...
RakeCircleCI.define_project_tasks(
  namespace: :circle_ci,
  project_slug: 'github/infrablocks/terraform-aws-ecs-route53-registration'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
  namespace: :github,
  repository: 'infrablocks/terraform-aws-ecs-route53-registration'
) do |t, args|
  github_config =
...
namespace :test do
  ...
  namespace :unit do
    ...
    task all: %w[
      test:unit:ecs_route53_registration_lambda
